...
int main()
{
  ...
  */
  ...
  for (int i =0; i < LENGTH; i++)
  {
    ...
    printf("item pointed to by ppi is %p (*ppi - this is the address pi points to)\n", *ppi);
    printf("item pointed to by double indirection of ppi is %d (**ppi)\n\n", **ppi);
    printf("The addresss of pi is %p and the value of ppi (what it points to) is %p\n\n", &pi, ppi);
